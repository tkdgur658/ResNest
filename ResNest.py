    ...
    def __init__(self, in_channles, num_classes, block, layers, radix=1, groups=1, bottleneck_width=64,
        ...
        if deep_stem:
            self.conv1 = nn.Sequential(
                conv_layer(in_channles, stem_width, kernel_size=3, stride=2, padding=1, bias=False, **conv_kwargs),
...
def resnest50(in_channles=1, num_classes=1, pretrained=False, root='~/.encoding/models', **kwargs):
    model = ResNet(in_channles, num_classes,Bottleneck, [3, 4, 6, 3],
...
def resnest269(pretrained=False, root='~/.encoding/models', **kwargs):
    ...
    return model
#resnest50(78,1)(torch.rand((4,78,224,224))).shape
